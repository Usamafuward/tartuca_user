    ...
    <div className="min-h-screen py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-card rounded-3xl p-8 sm:p-12 border border-white/10 shadow-2xl">
          ...
          <div className="space-y-6 text-slate-300 text-xs sm:text-sm leading-relaxed font-normal">
            <p>
            ...
            <h2 className="text-base font-serif font-bold text-white pt-2">1. Information We Collect</h2>
            <p>
            ...
            <h2 className="text-base font-serif font-bold text-white pt-2">2. How We Use Your Information</h2>
            ...
            <h2 className="text-base font-serif font-bold text-white pt-2">3. Security of Your Data</h2>
            <p>
            ...
            <h2 className="text-base font-serif font-bold text-white pt-2">4. Contact Us</h2>
            <p>
              If you have any questions or concerns regarding our privacy practices, please contact our team at <a href="mailto:info@tartuca.lk" className="text-amber-400 font-medium hover:underline">info@tartuca.lk</a>.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-card rounded-3xl p-8 sm:p-12 border border-white/10 shadow-2xl">
          ...
          <div className="space-y-6 text-slate-300 text-xs sm:text-sm leading-relaxed font-normal">
            ...
            <h2 className="text-base font-serif font-bold text-white pt-2">1. Table Reservations</h2>
            <p>
            ...
            <h2 className="text-base font-serif font-bold text-white pt-2">2. Online Orders & Delivery</h2>
            <p>
            ...
            <h2 className="text-base font-serif font-bold text-white pt-2">3. Cancellations & Refunds</h2>
            <p>
            ...
            <h2 className="text-base font-serif font-bold text-white pt-2">4. User Accounts</h2>
            <p>
